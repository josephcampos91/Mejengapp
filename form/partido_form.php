...
include("../class/cls_partido.php");

$value = "5";
$btn = "add";
$msj = "";
$num_jugadores = isset($_SESSION['num_jugadores'])?$_SESSION['num_jugadores'] : 0;
...
<br>
<span style="background: yellow;color: <?= $color_alert ?>;" ><?= $msj ?></span>
